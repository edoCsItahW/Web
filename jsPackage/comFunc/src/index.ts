...
class _Promise {
     ...
     * */
    success(cb: (res: IRecv) => void, errMsg: string = "Failed to receive data"): this {
 ...
 *     )
 * */
async function _request(url: string, reqHead: string, data: any, method: string = "POST", contentType: string = "application/json"): Promise<IRecv> {
 ...
 *     .success(res => { ... })
 * */
export function request(url: string, reqHead: string, data: any, method: string = "POST", contentType: string = "application/json") {
